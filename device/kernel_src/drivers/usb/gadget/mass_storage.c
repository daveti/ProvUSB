...
*/
#define DRIVER_DESC             "Trusted Mass Storage Gadget"
#define DRIVER_VERSION          "2014/04/30"
...
static struct usb_device_descriptor msg_device_desc = {
	...
	*/
	.idVendor =		cpu_to_le16(TRUSTED_FSG_VENDOR_ID),
...
static struct usb_configuration msg_config_driver = {
	...
	*/
	.label			= "Trusted Linux File-Backed Storage",
