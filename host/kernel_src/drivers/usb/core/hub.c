...
static int provusb_perf_new_device = 1;
static int provusb_perf_kernel_logging = 1;
...
//daveti
	...
	/* Start provusb perf */
	if (provusb_perf_new_device) {
		if (provusb_perf_kernel_logging)
			pr_info("provusb-perf: new device plugged\n");
		else
...
//daveti
	/* End provusb perf */
	if (provusb_perf_new_device && (!provusb_perf_kernel_logging)) {
		do_gettimeofday(&end_tv);
		pr_info("provusb-perf: usb_new_device took [%lu] us\n",
